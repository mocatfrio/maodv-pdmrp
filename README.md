...
**MANETs** *(Mobile Ad Hoc Networks)* atau jaringan Mesh adalah jaringan yang terdiri dari node-node bergerak yang saling berkomunikasi satu sama lain. Karakteristik jaringan MANET adalah:
  * Topologinya dinamis
