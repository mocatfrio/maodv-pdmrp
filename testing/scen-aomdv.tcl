...
set nsTrc [open result/aomdv-ns.tr w]
$ns trace-all $nsTrc

set namtrace    [open result/aomdv-nam.nam w]
$ns namtrace-all-wireless $namtrace $val(x) $val(y)

#set namTrc [open nam-aomdv.tr w] 
#$ns namtrace-all-wireless $namTrc $val(x) $val(y)
set scenarioTrc [open result/aomdv-scenario.tr w]
